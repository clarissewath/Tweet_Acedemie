...
<body>
    ...
    <div class="pt-5 mb-3 mt-5">
        ...
        <!-- Modal -->
        <div class="modal fade" id="editProfile" tabindex="-1" aria-labelledby="signUpLabel" aria-hidden="true">
                ...
                <div class="modal-content border border-light">
                    <div class="modal-body">
                        <div id="form">
                            ...
                            <br />
                            <form id="EditProfile_form" action="../app/Controllers/EditProfile.php" method="POST">
                                <h5>Edit your account</h5>
                                <div class="form-floating mb-3">
                                    <input type="text" name="name" class="form-control" id="changeName" maxlength="50">
                                    <label for="floatingInput">Name <span id="char"></span></label>
                                </div>
                                <div class="form-floating mb-3" id="mail">
                                    <input type="text" name="email" class="form-control" id="changeEmail" maxlength="50">
                                    <label for="floatingInput">Email</label>
                                </div>
                                <div class="form-floating mb-3" id="password">
                                    <input type="password" name="password" class="form-control" id="changePwd" maxlength="50">
                                    <label for="floatingInput">Password</label>
                                </div>
                                <br>
                                <br><br>
                                <div style="text-align: center;">
                                    <button type="submit" id="sendChanges" data-bs-dismiss="modal" class=" btn btn-primary">Send </button>
                                </div>
                        </div>
                        </form>
                    </div>
                ...
                <main>
                    ...
                    <div class="profile-info">
                        ...
                        <div class="edit-profile">
                            <button data-bs-toggle="modal" data-bs-target="#editProfile"> Edit profile</button>
                        </div>
                        <div id="info-account">
                            <span class="this-user"><?php echo $username->getUsers($_SESSION['userid'])['username']; ?></span>
                            ...
                            <div class="follow-user">
                                <a href="following.php" class="follow" id="account-following"><span class="nb-following">
                                        <?php
                                        $countFollowings = new Follow;
                                        echo ($countFollowings->getFollowings($_SESSION['userid'], 1)[0][0] ?? '0'); ?>
                                    </span>
                                    Following</span></a>
                                <a href="following.php" class="follow" id="account-followers"><span class="nb-follower">
                                        <?php
