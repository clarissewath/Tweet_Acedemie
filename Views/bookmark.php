<?php
include dirname(__DIR__) . DIRECTORY_SEPARATOR. 'app' . DIRECTORY_SEPARATOR . 'Controllers' .
    DIRECTORY_SEPARATOR . 'TweetController.php';
      ...
      <div class='col-lg-2 col-md-1 col-2' id="flex-nav">
        <nav>
          <ul class="nav flex-column" style="width: max-content;">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="#"><i class="far fa-bookmark"></i><span class="menu-text">
                  Bookmarks</span></a>
            </li>
            <li class="nav-item">
        ...
        <div class="trends">
          ...
          <a href="#" class="trend-1">
            <div class="trend-info">
              ...
              <span class="hashtag-trend">Michel blank 'Hair</span>
